...
pA <- ggplot() +
  geom_sf(data = ne_10_uk, fill = "khaki", color = "black") +
  geom_sf(data = env_data_sf_jittered, aes(color = gt), size = 3, shape = 17, alpha = 0.7) +
  labs(title = "A") +
  scale_color_manual(
...
# Save the figure
ggsave("../results/plots/combined_map_ordination_figure.png", 
