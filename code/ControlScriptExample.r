...
# If running the pipeline as standard (starting in the BioinformaticPipeline_Env directory) leave this unchanged. This designates the path to the working directory within which you have the following folders:
