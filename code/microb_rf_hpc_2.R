...
smartFilter <- function(data, target_col, max_features = 5000) {  # Reduced from 20000
...
parallelCV <- function(data, target_col, n_folds = 5, n_trees = 500,  # Reduced trees
...
n_trees <- 500  # Reduced from 1000 for faster testing
n_cv_folds <- 5
...
cv_results <- parallelCV(
    ...
    n_folds = n_cv_folds,
    n_trees = n_trees,
    mtry = NULL,  # Will be auto-calculated
    min_node_size = 5,
